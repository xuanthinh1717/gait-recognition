...
epochs = 15  # ← số epoch train THÊM, không phải tổng
...
for epoch in range(epochs):
    ...
    if epoch >= save_start_epoch and val_accuracy > best_val_accuracy:
        ...
        print(f"Model saved (best Val Accuracy: {best_val_accuracy:.2f}%)")
...
print(f"Best model saved to {model_file} with Val Accuracy: {best_val_accuracy:.2f}%")